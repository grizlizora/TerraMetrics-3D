self.onmessage = function(e) {
  ...
  rawGeoJson.features.forEach(feature => {
    ...
    // Derived from explicit indexes (no more mathematical calculations)
    const avgSalary = idx.salary || 0;
    ...
    const incomeTax = wb.tax_percent ? Math.round(wb.tax_percent) : (idx.tax || 0); // Prioritize World Bank tax
